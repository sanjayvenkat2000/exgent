...
We will instantiate a sheet_info_store
The base directory information will be provided in the environment variables "base_storage_dir"
We will add "{base_storage_dir}/shhet_info_store/sheet_info_store_db.sqllite" to initialize the database for the sheet_info_store
...
/update/{file_id}/{sheet_idx} (POST): Creates an updated entry in sheet_info_store
